...
export const createApi = (data) => request.post('/apis', data, { skipGlobalNetworkError: true })

export const updateApi = (id, data) => request.put(`/apis/${id}`, data, { skipGlobalNetworkError: true })
